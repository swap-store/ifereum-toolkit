    ...
    <BrowserRouter>
      <Flex mb="24px" p="8px" width="300px" border="1px solid grey" justifyContent="space-between" alignItems="center">
        ...
        >
          ...
          <SubMenuItem as={LinkExternal} href="https://ifereum.com" bold={false} color="text" target="blank">
            View on PCS Info
          </SubMenuItem>
      ...
      <Flex p="8px" width="300px" border="1px solid grey" justifyContent="space-between" alignItems="center">
        ...
        >
          ...
          <SubMenuItem as={LinkExternal} href="https://info.ifereum.com" bold={false} color="text" target="blank">
            View on PCS Info
          </SubMenuItem>
          <SubMenuItem as={Link} to="/profile">
            Go to profile page
