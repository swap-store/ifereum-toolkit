/**
 * @see https://github.com/swap-store/ifereum-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://bunny.ifereum.com/",
  },
  alice: {
    symbol: "ALICE",
    address: {
