...
import currentIFereumDefaultList from "../lists/ifereum-default.json";
import currentIFereumExtendedtList from "../lists/ifereum-extended.json";
import currentIFereumTop15List from "../lists/ifereum-top-15.json";
import currentIFereumTop100tList from "../lists/ifereum-top-100.json";
import currentCoingeckoList from "../lists/coingecko.json";
import currentIFereumMiniList from "../lists/ifereum-mini.json";
import currentIFereumMiniExtendedList from "../lists/ifereum-mini-extended.json";
import { buildList, VersionBump } from "../src/buildList";
import getTokenChainData from "../src/utils/getTokensChainData";

const currentLists = {
  "ifereum-default": currentIFereumDefaultList,
  "ifereum-extended": currentIFereumExtendedtList,
  "ifereum-top-100": currentIFereumTop100tList,
  "ifereum-top-15": currentIFereumTop15List,
  coingecko: currentCoingeckoList,
  "ifereum-mini": currentIFereumMiniList,
  "ifereum-mini-extended": currentIFereumMiniExtendedList,
};
...
expect.extend({
  ...
  toBeValidLogo(token) {
    ...
    const refersToLocalLogo = token.logoURI === `https://tokenlist.ifereum.com/images/${token.address}.png`;
